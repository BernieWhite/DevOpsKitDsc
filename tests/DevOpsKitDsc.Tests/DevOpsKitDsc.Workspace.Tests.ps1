...
Describe 'Workspace module' {
    ...
    Context 'Publish a module' {

        # Init the workspace
        $contextPath = Join-Path -Path $outputPath -ChildPath 'PublishModule';
        Initialize-DOKDsc -Path $contextPath -Force;
        ...
        Publish-DOKDscModule -WorkspacePath $contextPath -ModuleName 'Test' -ModuleVersion '1.0.0.0';
